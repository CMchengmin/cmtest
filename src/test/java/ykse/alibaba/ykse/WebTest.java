...
import ykse.help.WebBizHelper;
import ykse.help.WebFunHelper;
...
public class WebTest {
	...
	public static void setUp(String brower, String Path, String Url) throws Exception {
		...
		*/
		...
		driver = new RemoteWebDriver(new URL("http://192.168.10.148:4444/wd/hub"), dc); 
		driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
		driver.manage().window().maximize();
		baseUrl = Url;
	...
	public void TC_login() throws InterruptedException {
		...
		WebFunHelper.clickById("button_login_login",driver);
